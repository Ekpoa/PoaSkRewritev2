...
public class TeamPacket1219 {
    ...
    public static Object teamPacket(String teamName, String displayName, String nameTagVisibility, String collision, String color, String prefix, String suffix, boolean seeFriendly, Collection<String> players) {
        try {
            ...
            playerTeam.setPlayerPrefix(Components1219.nmsComponentActual(MiniMessage.miniMessage().deserialize(prefix)));
            playerTeam.setPlayerSuffix(Components1219.nmsComponentActual(MiniMessage.miniMessage().deserialize(suffix)));
            ...
            playerTeam.setDisplayName(Components1219.nmsComponentActual(MiniMessage.miniMessage().deserialize(displayName)));
