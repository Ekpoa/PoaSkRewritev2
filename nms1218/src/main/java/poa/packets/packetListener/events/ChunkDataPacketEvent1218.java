...
public class ChunkDataPacketEvent1218 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent1218(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
