...
public class ChunkDataPacketEvent1217 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent1217(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
