...
public class Metadata1202 {
    ...
    public static Object basePacketForEntity(int id, boolean fire, boolean invisible, boolean glow, String name, boolean nameVisible, boolean silent, boolean gravity, String pose) {
        Metadata1202 entityMetadata = new Metadata1202(id);
    ...
    public void setName(String name) {
        ...
        Optional<net.minecraft.network.chat.Component> optional = Optional.of(Components1202.nmsComponentActual(MiniMessage.miniMessage().deserialize(name)));
    ...
    public void setText(Component component){
        dataList.add(new SynchedEntityData.DataValue<>(23, EntityDataSerializers.COMPONENT, Components1202.nmsComponentActual(component)));
    }
