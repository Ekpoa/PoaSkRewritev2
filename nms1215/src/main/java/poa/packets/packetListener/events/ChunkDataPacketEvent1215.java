...
public class ChunkDataPacketEvent1215 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent1215(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
