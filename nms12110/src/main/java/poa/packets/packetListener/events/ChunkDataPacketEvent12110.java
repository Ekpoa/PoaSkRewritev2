...
public class ChunkDataPacketEvent12110 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent12110(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
