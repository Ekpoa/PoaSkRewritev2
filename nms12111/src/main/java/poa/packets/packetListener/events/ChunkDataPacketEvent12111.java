...
public class ChunkDataPacketEvent12111 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent12111(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
