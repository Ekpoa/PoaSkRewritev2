...
public class Metadata1216 {
    ...
    public static Object basePacketForEntity(int id, boolean fire, boolean invisible, boolean glow, String name, boolean nameVisible, boolean silent, boolean gravity, String pose) {
        Metadata1216 entityMetadata = new Metadata1216(id);
    ...
    public void setName(String name) {
        ...
        dataList.add(new SynchedEntityData.DataValue<>(2, EntityDataSerializers.OPTIONAL_COMPONENT, Optional.of(Components1216.nmsComponentActual(MiniMessage.miniMessage().deserialize(name)))));
    }
    ...
    public void setText(Component component){
        dataList.add(new SynchedEntityData.DataValue<>(23, EntityDataSerializers.COMPONENT, Components1216.nmsComponentActual(component)));
    }
