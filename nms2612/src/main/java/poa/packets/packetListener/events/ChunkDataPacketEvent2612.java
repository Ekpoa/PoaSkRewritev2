...
public class ChunkDataPacketEvent2612 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent2612(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
