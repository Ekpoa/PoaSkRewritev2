...
public class ChunkDataPacketEvent1211 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent1211(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
