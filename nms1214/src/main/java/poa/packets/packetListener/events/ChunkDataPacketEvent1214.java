...
public class ChunkDataPacketEvent1214 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent1214(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
