...
public class Metadata1213 {
    ...
    public static Object basePacketForEntity(int id, boolean fire, boolean invisible, boolean glow, String name, boolean nameVisible, boolean silent, boolean gravity, String pose) {
        Metadata1213 entityMetadata = new Metadata1213(id);
    ...
    public void setName(String name) {
        ...
        dataList.add(new SynchedEntityData.DataValue<>(2, EntityDataSerializers.OPTIONAL_COMPONENT, Optional.of(Components1213.nmsComponentActual(MiniMessage.miniMessage().deserialize(name)))));
    }
    ...
    public void setText(Component component){
        dataList.add(new SynchedEntityData.DataValue<>(23, EntityDataSerializers.COMPONENT, Components1213.nmsComponentActual(component)));
    }
