...
public class ChunkDataPacketEvent1213 extends Event implements Cancellable {
    ...
    public ChunkDataPacketEvent1213(Player player, boolean async, int chunkX, int chunkZ) {
        super(async);
        this.player = player;
